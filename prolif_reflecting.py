...
def simulate_prolif(init_latt,t_init,t_final,dt,rp,rm,K,k_reset):
    """
    ...
    #Initialise proliferation attempts counter, and time array
            ...
            #Otherwise attempt proliferation
                ...
                if direction == "up":
                    ...
                    if lattice_old[new_x, new_y] == 0:  # Check if new position is empty
                        ...
                        lattice_now[x_idx, y_idx] = k_reset  # Reset to stage k_reset
                    ...
                    #reflective boundary condition
                    if new_x < 0 :
                        #fail proliferation if at left edge
                        lattice_now[x_idx, y_idx] = k_reset
                    #Regular proliferation attempt otherwise    
                    else:
                        if lattice_old[new_x, new_y] == 0:  # Check if new position is empty
                            lattice_now[new_x, new_y] = 1  # add new cell
                            lattice_now[x_idx, y_idx] = 1  # reset old cell
                    ...
                    #reflective boundary condition
                    if new_x >= Lx :
                        #fail proliferation if at right edge
                        lattice_now[x_idx, y_idx] = k_reset
                    #Regular proliferation attempt otherwise
                    else:
                        if lattice_old[new_x, new_y] == 0:  # Check if new position is empty
                ...
                if success:
                    ...
                    #Increment failed proliferation attempts counter
